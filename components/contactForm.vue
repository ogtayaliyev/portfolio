    ...
    async submitForm() {
      ...
      try {
        ...
        if (Object.keys(this.errors).length === 0) {
          const serviceID = 'service_qjz22ok'; // Remplacez par votre Service ID EmailJS
          const templateID = 'template_9a213zh'; // Remplacez par votre Template ID EmailJS
          const publicKey = 'ar3vkO_RmfTuxP5yY'; // Remplacez par votre API Key EmailJS
